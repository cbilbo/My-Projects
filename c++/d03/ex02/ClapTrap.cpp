...
/*   Updated: 2021/12/10 17:38:43 by cbilbo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _name("Default"), _hp(0), _ep(0), _dmg(0)
{
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	if (getHp() < 0)
		setHp(0);
	std::cout << "Trap " << getName() << " is taken " << amount << " damage. " << getHp() << " hitpoints left!" << std::endl;
}
void	ClapTrap::beRepaired(unsigned int amount)
{
	setHp(amount);
	std::cout << "Trap " << getName() << " was repaired by " << amount << " hitpoints!" << std::endl;
}
